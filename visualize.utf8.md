...
\begin{figure}
\includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-10-1} \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-10-2} \end{figure}
...
{\centering \includegraphics[width=0.75\linewidth]{visualize_files/figure-latex/shapes-1} 
...
1.  What's gone wrong with this code? Why are the points not blue?
    ...
    \begin{center}\includegraphics[width=0.7\linewidth]{visualize_files/figure-latex/unnamed-chunk-12-1} \end{center}
...
\includegraphics[width=0.33\linewidth]{visualize_files/figure-latex/unnamed-chunk-22-1} \includegraphics[width=0.33\linewidth]{visualize_files/figure-latex/unnamed-chunk-22-2} \includegraphics[width=0.33\linewidth]{visualize_files/figure-latex/unnamed-chunk-22-3} 
...
1.  Recreate the R code necessary to generate the following graphs.
    ...
    \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-29-1} \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-29-2} \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-29-3} \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-29-4} \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-29-5} \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-29-6} 
...
\includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-37-1} \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-37-2} 
...
*   `position = "identity"` will place each object exactly where it falls in 
    ...
    \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-39-1} \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-39-2} 
...
*   `coord_flip()` switches the x and y axes. This is useful (for example),
    ...
    \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-45-1} \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-45-2} 
...
*   `coord_quickmap()` sets the aspect ratio correctly for maps. This is very
    ...
    \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-46-1} \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-46-2} 
...
*   `coord_polar()` uses polar coordinates. Polar coordinates reveal an 
    ...
    \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-47-1} \includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-47-2} 
...
1.  What does the plot below tell you about the relationship between city
    ...
    \begin{center}\includegraphics[width=0.5\linewidth]{visualize_files/figure-latex/unnamed-chunk-48-1} \end{center}
